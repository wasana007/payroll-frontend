...
export default function App() {
  const [form, setForm]               = useState<FormState>({ ansattId: "", loenn: "", maaned: "" });
  ...
  const isValid = !!(form.ansattId.trim() && parseFloat(form.loenn) > 0 && form.maaned.trim());
  ...
  return (
    <div className="app">
      <header className="header">
        ...
        <div className="badge"><span className="pulse-dot" /></div>
      </header>
